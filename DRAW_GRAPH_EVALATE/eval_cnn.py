...
if wsl:
    images_drowsy= glob.glob(r'/mnt/d/BIG_PROJECT/face-detection-yolov8/test_face_images/test_cnn/drowsy/*.*')
    images_non_drowsy= glob.glob(r'/mnt/d/BIG_PROJECT/face-detection-yolov8/test_face_images/test_cnn/non-drowsy/*.*')
    test = []
    label = []

    vgg_local = r"/mnt/e/HOC_TAP/NCKH/model/VGG/local_vgg_official.h5" # cv2 processing
    vgg_cluster1 = r"/mnt/e/HOC_TAP/NCKH/model/VGG/cluster1_vgg_500.h5"
    vgg_cluster2 = r"/mnt/e/HOC_TAP/NCKH/model/VGG/cluster2_vgg_official.h5"
     
    lstm_local = r"/mnt/e/HOC_TAP/NCKH/model/resnet/local_resnet_official.h5" #keras processing
    lstm_cluster1 = r"/mnt/e/HOC_TAP/NCKH/model/LSTM/cluster1_LSTM_official.h5"
    lstm_cluster2 = r"/mnt/e/HOC_TAP/NCKH/model/LSTM/cluster2_lstm_official.h5"

    resnet_local = r"/mnt/e/HOC_TAP/NCKH/model/resnet/local_resnet_official.h5"
    resnet_cluster1 = r"/mnt/e/HOC_TAP/NCKH/model/resnet/cluster1_resnet_official.h5"

    den_local = r"/mnt/e/HOC_TAP/NCKH/model/dense/local2_densenet_500.h5" #keras processing
    den_cluster1 = r"/mnt/e/HOC_TAP/NCKH/model/dense/cluster1_densenet_official.h5"
    den_cluster2 = r"/mnt/e/HOC_TAP/NCKH/model/dense/cluster2_densenet_official.h5"
else:
...
model = tf.keras.models.load_model(resnet_local,compile=True)#Load model with DNN:
